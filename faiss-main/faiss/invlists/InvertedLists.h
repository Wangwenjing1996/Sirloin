...
struct InvertedLists {
    ...
    virtual const float* get_o2c(size_t list_no) const {};

    virtual bool delete_oldest( size_t list_no, size_t bound, float *cnts, size_t M, size_t K) {};
    ...
    virtual void expand( size_t new_nlist) {};
